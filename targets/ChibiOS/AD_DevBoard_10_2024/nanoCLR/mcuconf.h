 ...
 */
 ...
 // "False" Disables the PWR/RCC initialization in the HAL
...
// MSION Missing (MSI clock enable)
// MSIRDY Missing (MSI clock ready flag)
// MSIRGSEL Missing (MSI clock range selection)
// HSIKERON Missing (HSI16 always enable for peripheral kernels)
// HSIRDY Missing (HSI16 clock ready flag)
// HSIASFS Missing (HSI16 automatic start from Stop)
// HSERDY Missing (HSE clock ready flag)
// HSEBYP Missing (HSE crystal oscillator bypass)
// CSSON Missing (Clock security system enable)
// PLLON Missing (Main PLL enable)
// PLLRDY Missing (Main PLL clock ready flag)
// PLLSAI1ON Missing (SAI1 PLL enable)
// PLLSAI1RDY Missing (SAI1 PLL clock ready flag)
// PLLSAI2ON Missing (SAI2 PLL enable)
// PLLSAI2RDY Missing (SAI2 PLL clock ready flag)
...
// LSIRDY Missing (LSI oscillator ready)
// LSIPREDIV Missing (Internal low-speed oscillator predivided by 128)
// RMVF Missing (Remove reset flag)
// FWRSTF Missing (Firewall reset flag)
// OBLRSTF Missing (Option byte loader reset flag)
// PINRSTF Missing (Pin reset flag)
// BORRSTF Missing (BOR flag)
// SFTRSTF Missing (Software reset flag)
// IWDGRSTF Missing (Independent window watchdog reset flag)
// WWDGRSTF Missing (Window watchdog reset flag)
// LPWRRSTF Missing (Low-power reset flag)

// RCC_CRRCR Clock recovery RC register
// HSI48ON HSI48 clock enable
#define STM32_HSI48_ENABLED                 TRUE
// HSI48RDY Missing (HSI48 clock ready flag)
// HSI48CAL Missing (HSI48 clock calibration)

// RCC_CFGR Clock configuration register
// System Clock Selection (can view active clock in RCC_CFGR_SWS)
// Forced to MSI when exiting Shutdown standby modes
// Forced to MSI or HSI16 when exiting stop mode set by STOPWUCK
#define STM32_SW                            STM32_SW_PLL
// AHB Prescaler
#define STM32_HPRE                          STM32_HPRE_DIV1
// APB high-speed prescaler
#define STM32_PPRE1                         STM32_PPRE1_DIV4  // JAT changed from 1 2-4-25
// APB low-speed prescaler
#define STM32_PPRE2                         STM32_PPRE2_DIV4  // JAT changed from 1 2-4-25
#define STM32_STOPWUCK                      STM32_STOPWUCK_MSI
// Microcontroller Clock Output
#define STM32_MCOSEL                        STM32_MCOSEL_NOCLOCK
// Microcontroller Clock Output prescaler
#define STM32_MCOPRE                        STM32_MCOPRE_DIV1
// Missing SWS (Read only)

// RCC_PLLCFGR PLL configuration register
#define STM32_PLLSRC                        STM32_PLLSRC_MSI
// Division factor for the main PLLinput clock
#define STM32_PLLM_VALUE                    1
// Main PLL multiplication factor for VCO
#define STM32_PLLN_VALUE                    48  // JAT changed from 60 2-4-25
...
// PLLPEN Missing (Main PLL PLLSAI3CLK output enable)
// PLLQEN Missing (Main PLL PLL48M1CLK output enable)
// PLLREN Missing (Main PLL PLLCLK output enable)
// PLLPDIV Missing (Main PLLP division factor for PLLSAI3CLK)

// RCC_PLLSAI1CFGR PLLSAI1 configuration register
// PLLSAI1 multiplication factor for VCO
#define STM32_PLLSAI1N_VALUE                48  // JAT changed from 60 2-4-25
...
// PLLSAI1M Missing (Division factor for PLLSAI1 input clock)
// PLLSAI1PEN Missing (PLLSAI1 PLLSAI1CLK output enable)
// PLLSAI1QEN Missing (PLLSAI1 PLL48M2CLK output enable)
// PLLSAI1REN Missing (PLLSAI1 PLLADC1CLK output enable)
// PLLSAI1PDIV Missing (PLLSAI1 division factor for PLLSAI1CLK)

// RCC_PLLSAI2CFGR PLLSAI2 configuration register
// PLLSAI2 multiplication factor for VCO
#define STM32_PLLSAI2N_VALUE                48  // JAT changed from 60 2-4-25
// PLLSAI2 division factor for PLLSAI1CLK (SAI1 or SAI2 clock)
#define STM32_PLLSAI2P_VALUE                7
// PLLSAI2 division factor for PLLLCDCLK (LTDC clock)
#define STM32_PLLSAI2R_VALUE                2
// PLLSAI2M Missing (Division factor for PLLSAI2 input clock)
// PLLSAI2PEN Missing (PLLSAI2 PLLSAI2CLK output enable)
// PLLSAI2QEN Missing (PLLSAI2 division factor for PLLDSICLK (DSI clock))
// PLLSAI2Q Missing (PLLSAI2 PLLDSICLK output enable)
// PLLSAI2REN Missing (PLLSAI2 PLLLCDCLK output enable)
// PLLSAI2PDIV Missing (PLLSAI2 division factor for PLLSAI2CLK)
...
// Reference Manual Page 190 Section 5.1.8 Dynamic voltage scaling management
// PWR_CR1 (register)
// Range 1 Core voltage 1.2 Volts
// Range 2 Core voltage 1.0 Volt
#define STM32_VOS                           STM32_VOS_RANGE1
// PWR_CR5 (register)
// R1MODE 0 is boost mode(1.28V) 1 is normal mode(1.2V)
 ...
 */
// DCY: Changed ADC settings 11-13-2024
